...
const orders = [
  ...
  { id: 3, user: 'User3', requestDate: '2024-07-13', title: 'Other', status: 'Replied', description: 'Customized dietary requirements', userImage: 'https://t4.ftcdn.net/jpg/03/83/25/83/360_F_383258331_D8imaEMl8Q3lf7EKU2Pi78Cn0R7KkW9o.jpg' },
  { id: 4, user: 'User4', requestDate: '2024-07-12', title: 'Weight Gain', status: 'Not Replied', description: 'Weight gain strategy', userImage: 'https://sources.roboflow.com/dzuGOec8v6bRLhxo590fQ69a22N2/cNc6Q78185vhZDZhqEdS/original.jpg' },
  { id: 5, user: 'User5', requestDate: '2024-07-11', title: 'Muscle gain', status: 'Replied', description: 'Building muscle mass plan', userImage: 'https://t4.ftcdn.net/jpg/03/03/11/75/360_F_303117590_NNmo6BS2fOBEmDp8uKs2maYmt03t8fSL.jpg' },
  { id: 6, user: 'User6', requestDate: '2024-07-10', title: 'Others', status: 'Not Replied', description: 'General nutrition advice', userImage: 'https://via.placeholder.com/150/6' },
];
