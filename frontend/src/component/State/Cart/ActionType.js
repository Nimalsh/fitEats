...
export const REMOVE_CARTITEM_REQUEST = "UPDATE_CARTITEM_REQUEST";
export const REMOVE_CARTITEM_SUCCESS = "UPDATE_CARTITEM_SUCCESS";
export const REMOVE_CARTITEM_FAILURE = "UPDATE_CARTITEM_FAILURE";
